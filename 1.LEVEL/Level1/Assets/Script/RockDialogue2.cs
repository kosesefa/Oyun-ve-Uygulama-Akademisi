...
public class RockDialogue2 : MonoBehaviour
{
    //Dialogues
    ...
    [SerializeField] GameObject RockDialogueDollyCart;
    ...
    void Start()
    {
        RockDialogueDollyCart.SetActive(false);
        ...
        RockText.transform.GetComponent<Text>().text = "Artýk bu evrene özgü özelliklerin hepsini keþfettin.Zamanla bunlarda ustalaþacaksýn ama þimdi onlarýn hepsini kullanmaný gerektiren anlarda potansiyelini saklama!";
