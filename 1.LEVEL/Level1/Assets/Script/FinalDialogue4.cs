...
public class FinalDialogue4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        RockPanel2.GetComponent<Transform>().localPosition = new Vector3(0, -247, 0f);
        RockPanel2.GetComponent<Transform>().localScale = new Vector3(15.22f, 1.99f, 1);
        ...
        RockText2.transform.GetComponent<Text>().text = "Senin yaþamýn bir gerçeklik sapmasýdýr. Yaþadýðýn bir deneyim seni gerçeklikten koparýyor ve bu sistemi dengesiz hale getirebilecek bir sapma tehlikesi oluþturuyor. Dengeyi bozan, ikiliði þaþýrtan bir hareketle buraya geldin ve yaþamýn kaçýnýlmaz bir þekilde buraya kadar getirdi";
        RockText2.transform.GetComponent<Text>().font = Rock_Font2;
        RockText2.transform.GetComponent<Text>().fontSize = 34;
        RockText2.transform.GetComponent<Text>().lineSpacing = 1.15f;
        RockRectTransform2 = RockMyText2.GetComponent<RectTransform>();


        // Text position
        RockRectTransform2 = RockText2.GetComponent<RectTransform>();
        RockRectTransform2.localPosition = new Vector3(0, -247, 0);
        RockRectTransform2.sizeDelta = new Vector2(1512, 157.2f);
        ...
        RockDialogueContinue2.transform.GetComponent<Transform>().localPosition = new Vector3(640, -289, 0);
