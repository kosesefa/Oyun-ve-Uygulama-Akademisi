...
public class FinalDialogue3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        RockText2.transform.GetComponent<Text>().text = "Ýnsan ana karnýndan doðar doðmaz kader onun ömür ipliðini bükmeye koyulur, üç Moira her insanýn ipliðini büker dururlar, günün birinde de keserler, o anda insan ölür.”";
