...
public class RockDialogue : MonoBehaviour
{
    //Dialogues
    ...
    void Start()
    {
        ...
        RockInfoTextCanvas.name = "Ýnfo Canvas";
        ...
        Rock_InfoText.transform.GetComponent<Text>().text = "Press F to Talk";
        ...
        RockTextDC.transform.GetComponent<Text>().text = "Continue";
