...
public class FinalDialogue5 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        RockPanel2.GetComponent<Transform>().localPosition = new Vector3(0, -284.07f, 0f);
        RockPanel2.GetComponent<Transform>().localScale = new Vector3(17.02f, 3.35f, 1);
        ...
        RockText2.transform.GetComponent<Text>().text = "Bilincin ve gerçekliðin burada sona erecek ve her þeye tekrar baþlayacaksýn. Bu dengeyi bozacak olay yeniden gerçekleþecek ve buraya geleceksin, tekrar ve tekrar. Buraya ilk geliþin deðil Otis, daha önce de burada bulundun.Senin yarattýðýn bu bozukluk bile bir ahenk içinde var oluyor. Bu döngüde senin her defasýnda ayný yere ulaþman ve tekrar baþa dönmen bir arayýþ deðil.";
        ...
        RockRectTransform2.localPosition = new Vector3(0, -301.4f, 0);
        RockRectTransform2.sizeDelta = new Vector2(1608.4f, 288.4f);
        ...
        RockDialogueContinue2.transform.GetComponent<Transform>().localPosition = new Vector3(691, -395, 0);
