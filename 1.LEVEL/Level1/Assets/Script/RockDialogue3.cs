...
public class RockDialogue3 : MonoBehaviour
{
    //Dialogues
    ...
    [SerializeField] GameObject RockDialogueDollyCart2;
    ...
    void Start()
    {
        RockDialogueDollyCart2.SetActive(false);
        ...
        RockText2.transform.GetComponent<Text>().text = "Burada taþlarý itmen gerekiyor. Gizli bir yerde bir taþ daha bulacaksýn ve onu da oyun alanýna götürmen gerekiyor.Oyunun bittiðini gökten gelecek bir cisim ile anlayacaksýn.";
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.F) && RockInDialogueSize2 == true)
        {
            ...
            RockDialogueDollyCart2.SetActive(true);
            RockCanESC2 = false;
            Cursor.visible = true;
            //ROCKAudio.Play();
