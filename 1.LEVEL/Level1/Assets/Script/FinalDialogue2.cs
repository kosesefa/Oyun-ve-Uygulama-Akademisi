...
public class FinalDialogue2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        RockText2.transform.GetComponent<Text>().text = "Yukarýya çýkmaya devam et. Gökten düþen meteorlar yolunu aksatabilir, attýðýn her adýmý gözle ve dikkat et.Bu yollarda yürüyen ilk kiþi sen deðilsin ve son kiþi de olmayacaksýn.";
